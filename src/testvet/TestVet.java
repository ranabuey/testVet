...
//
//        }
// MODIFICAR CLIENTE (FALTABA EL ID)
//        Cliente testMod = cd.buscarClienteId(4);
//        testMod.setNombreAlternativo("alguno");
//        cd.modificarCliente(testMod);
//        
        
       Visita visitaTest= vd.buscarVisitaXid(3);
        System.out.println("idmascota "+visitaTest.getMascota().getIdMascota());
     //   System.out.println(""+vd.chkVisitaMismoDia(visitaTest));
    }
